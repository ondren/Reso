...
public class UnimportantMessagesActivity extends Activity {
    ...
    void redraw(){
        ...
        ApiAccess.get("messages/get/dish",
            response -> {
                try {
                    ...
                    for (int i = 0; i < JSONArray_messages.length(); i++){
                        ...
                        message_btn.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                        ...
                        message_btn.setOnClickListener(view -> {
                            Intent intent = new Intent(UnimportantMessagesActivity.this, MessageConfirmActivity.class);
